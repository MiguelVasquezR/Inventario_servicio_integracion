 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Producto" type="{t4is.uv.mx/factura}DetalleProductoType" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class ProductoType {
    ...
    protected List<DetalleProductoType> producto;
     ...
     * {@link DetalleProductoType }
     * 
     * 
     */
    public List<DetalleProductoType> getProducto() {
        if (producto == null) {
            producto = new ArrayList<DetalleProductoType>();
        }
