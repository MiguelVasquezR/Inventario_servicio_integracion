...
public class GenerarFacturaResponse {
    ...
    protected GenerarFacturaResponse.Productos productos;
    @XmlElement(name = "DatosVendedor", required = true)
    protected GenerarFacturaResponse.DatosVendedor datosVendedor;
     ...
     * @return
     *     possible object is
     *     {@link GenerarFacturaResponse.Productos }
     *     
     */
    public GenerarFacturaResponse.Productos getProductos() {
        return productos;
    }
     ...
     *     
     */
    public void setProductos(GenerarFacturaResponse.Productos value) {
     ...
     * @return
     *     possible object is
     *     {@link GenerarFacturaResponse.DatosVendedor }
     *     
     */
    public GenerarFacturaResponse.DatosVendedor getDatosVendedor() {
     ...
     *     
     */
    public void setDatosVendedor(GenerarFacturaResponse.DatosVendedor value) {
    ...
    public static class Productos {
        ...
        protected List<GenerarFacturaResponse.Productos.Producto> producto;
         ...
         * {@link GenerarFacturaResponse.Productos.Producto }
         * 
         * 
         */
        public List<GenerarFacturaResponse.Productos.Producto> getProducto() {
            if (producto == null) {
                producto = new ArrayList<GenerarFacturaResponse.Productos.Producto>();
            }
